...
pheno=$1
    ...
    python ~/Programs/ldsc/munge_sumstats.py --snp ID --a1 ALT --a2 REF --N-col OBS_CT --sumstats $sumstats.ldsc --chunksize 500000 --merge-alleles $snp_lst --out $folder.$pheno
